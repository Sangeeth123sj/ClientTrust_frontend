  ...
  "node_modules/annyang/dist/annyang.min.js"(exports, module) {
    ...
    !function(e, n) {
      ...
      return t = { init: function(e2) {
        ...
        a && a.abort && a.abort(), (a = new o()).maxAlternatives = 5, a.continuous = "http:" === r.location.protocol, a.lang = "en-US", a.onstart = function() {
          ...
          switch (S(u.error, e3), e3.error) {
            ...
            case "service-not-allowed":
              c = false, new Date().getTime() - f < 200 ? S(u.errorPermissionBlocked, e3) : S(u.errorPermissionDenied, e3);
          }
        }, a.onend = function() {
          if (m = false, S(u.end), c) {
            var e3 = new Date().getTime() - f;
        ...
        x(), g = (e2 = e2 || {}).paused !== i && !!e2.paused, c = e2.autoRestart === i || !!e2.autoRestart, e2.continuous !== i && (a.continuous = !!e2.continuous), f = new Date().getTime();
        try {
          a.start();
        } catch (e3) {
          d && k(e3.message);
